...
## [1.5.6] 2025/03/04
Filtering update to include more options (Agent - WebUser)

### Changed
- agent_controller - webuser_controller.rb
    - Followed same steps from 1.5.5
- agent - webuser/index.html.erb
    - Followed same steps from 1.5.5
